...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-yfvcm-8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-yfvcm-8.containers.anotherwebservice.com/
...
```
git clone git@github.com:euluan1912/container-yfvcm-8.git
cd container-yfvcm-8
```
...
```
docker attach container-yfvcm-8
```
